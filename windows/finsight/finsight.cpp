// finsight.cpp : Defines the entry point for the application.
//
...
_Use_decl_annotations_ int CALLBACK WinMain(HINSTANCE instance, HINSTANCE, PSTR /* commandLine */, int showCmd) {
  ...
  //port
  settings.SourceBundleHost(L"localhost:8088");
  ...
  appWindow.SetIcon(std::wstring(appDirectory).append(L"\\finsight.ico").c_str());
